...
echo "Hey $1! Please review the info below."
echo '**************************************************'; echo
echo "Your username for this loaner is going to be: $USER_LOGIN"; echo
echo "Your password for this loaner is going to be: $USER_PASSWORD"; echo
echo "**************************************************"
echo "Would you like to change the above info?"
